...
<body>
	...
	<form  action="registration.php" method="post" enctype="multipart/form-data">
		<div id="id7">
			<table style="color:black;" height="350" width="700">
				<tr>
					<td>Username</td>
				...
				<tr>
					<td>Password</td>
					<td><input type="password" name="b"><br></td>
				</tr>
				<tr>
					<td>Branch</td>
				...
				<tr>
					<td>Mobile</td>
					<td><input type="text" name="d"><br></td>
				</tr>
				<tr>
					<td>Address</td>
					<td><textarea name="e"></textarea><br></td>
				</tr>
				<tr>
					<td>Image</td>
					<td><input type="file"  name="f"><br></td>
				</tr>
				<tr>
